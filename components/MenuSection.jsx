...
export default function MenuSection() {
  ...
  return (
    <section className="home-section home-menu" id="cuisines">
      ...
      <div className="home-cuisine-grid">
        {cuisines.map((cuisine, index) => (
          <button className={`home-cuisine-card home-cuisine-${index + 1}`} key={cuisine.name} type="button" onClick={() => setSelected(cuisine)}>
